        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service, i) => (
            <motion.a
              ...
              className="group relative flex flex-col overflow-hidden rounded-card border border-ink/6 bg-mist p-6 transition-all duration-300 hover:border-brand-red/20 hover:bg-paper hover:shadow-glass-lg"
            >
              <div className="mb-4 flex items-center justify-between">
                <span className="font-mono text-[11px] font-semibold tracking-widest text-body/40">
              ...
              <span className="absolute inset-x-6 bottom-0 h-px origin-left scale-x-0 bg-brand-red transition-transform duration-500 ease-nav group-hover:scale-x-100" />
            </motion.a>
          ))}
        </div>
      </div>
