// components/sections/Subscribers.tsx
"use client";
          ...
          {subscriberStats.map((stat, i) => {
            ...
            return (
              <motion.div
                ...
                className="group relative overflow-hidden rounded-card border border-ink/6 bg-paper p-6 transition-shadow duration-300 hover:shadow-glass-lg"
              >
                ...
                <div className="absolute -right-8 -bottom-8 h-24 w-24 rounded-full bg-brand-red/5 transition-transform duration-500 group-hover:scale-150" />
              </motion.div>
            );
          })}
        </div>
