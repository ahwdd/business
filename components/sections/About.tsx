          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {aboutHighlights.map((item, i) => (
              <motion.div
                ...
                className={`group relative overflow-hidden rounded-card border border-ink/[0.06] bg-mist p-6 transition-colors duration-300 hover:bg-paper hover:shadow-glass-lg ${
                  i === 0 ? "sm:col-span-2" : ""
                }`}
              >
                <div className="absolute -right-6 -top-6 h-24 w-24 rounded-full bg-brand-red/[0.06] transition-transform duration-500 group-hover:scale-150" />
