            ...
            <div className="grid gap-4">
              {contactInfo.locations.map((loc, i) => (
                <motion.div
                  ...
                  custom={i + 1}
                  variants={fadeUpItem}
                  className="group flex items-center gap-4 rounded-card border border-ink/6 bg-paper/70 p-5 transition-all duration-300 hover:border-brand-red/20 hover:shadow-glass-lg"
                >
              ...
              <div className="flex items-center gap-3 rounded-card border border-brand-red/20 bg-brand-red/6 p-5">
