      ...
      <div className="relative mx-auto max-w-[1240px] px-6">
        <div className="grid gap-12 border-b border-white/10 pb-14 lg:grid-cols-[1.2fr_0.8fr_1fr]">
              ...
              {footerLinks.social.map((item) => {
                ...
                return (
                  <a
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/[0.04] text-white/60 transition-all duration-300 hover:border-brand-red/40 hover:bg-brand-red/10 hover:text-white"
                  >
          ...
          <div>
            ...
            <form
              className="flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] p-1.5 backdrop-blur-md transition-colors duration-300 focus-within:border-brand-red/40"
            ...
            >
              ...
              <button
                type="submit"
                className="shrink-0 rounded-full bg-white px-4 py-2.5 text-xs font-semibold text-ink transition-colors duration-300 hover:bg-brand-red hover:text-white"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="flex flex-col items-center justify-between gap-4 pt-8 sm:flex-row">
          ...
          <div className="flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-4 py-2 text-xs font-medium text-white/45">
